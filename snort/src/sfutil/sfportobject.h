...
void         PortTablePrintInputEx( PortTable * p, void (*rule_index_map_print)(int index) );
int          PortTablePrintCompiledEx( PortTable * p, void (*rule_index_map_print)(int index) );
...
PortObject2    * PortObjectNew2       (int nrules/*guess at this */);
void             PortObjectFree       ( void *  p );
void             PortObjectFree2      ( void *  p );
